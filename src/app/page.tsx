...
export default function Home() {
  ...
  async function checkLocalRanking() {
    ...
    try {
      const result = await rankHypothesesWithHostedSpace([{ id: "pool-limit", claim: "Deploy r42 reduced the pool limit and exhausted connections." }, { id: "dns-event", claim: "The overlapping DNS event caused the outage." }], { signal: controller.signal });
