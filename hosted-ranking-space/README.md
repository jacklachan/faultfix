...
3. A selectable, read-only public case library derived from Google's GCE networking postmortem and Cloudflare's November 2025 outage postmortem. Every displayed artifact carries its provenance, stable fingerprint, source link, and data boundary; it is public postmortem evidence, not private raw telemetry.
