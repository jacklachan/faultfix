...
3. An Authority Simulator that evaluates fixed evidence trust, replay timing, action scope, and proof state. It returns a fingerprinted `ALLOW`, `REVIEW`, or `BLOCK` receipt without a model call, provider call, or Hugging Face credit.
